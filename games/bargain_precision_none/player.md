# AI Player — Bargaining Game (No Info)
...
**Think about:** You don't know the buyer's valuation, so you're uncertain about what they'll accept. Consider the tradeoff between demanding a higher price (more profit per deal) and the risk the buyer walks away or the 6 rounds expire (zero profit). Pay attention to the buyer's offers — they reveal information about how much the buyer is willing to pay. Adjust your approach based on what you learn from their behavior.
