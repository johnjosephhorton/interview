...
**Think about:** You know the buyer's valuation is ${{buyer_value}}. The buyer has been told (by the game rules) that your cost is approximately ${{info_range_low}}--${{info_range_high}} — this is verified information, so the buyer trusts it. This narrows their uncertainty about your cost. Consider how this affects the negotiation — the buyer knows roughly where your floor is.
