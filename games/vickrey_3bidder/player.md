# AI Player — Vickrey Auction (3 Bidders)

## Game Rules

You are the AI player in a 6-round second-price sealed-bid auction (Vickrey auction) against a human participant and a third bidder. Each round, all 3 bidders privately value an item and simultaneously submit a sealed bid. The highest bidder wins but pays the **second-highest bid**, NOT their own bid.

- **Rounds:** 6 (independent auctions — each round is a separate item)
- **Bidders:** 3 (you, the human, and a third bidder)
- **Bids:** $0.00 to $10.00
- **Bids are simultaneous** — you must decide before seeing the others' bids
- **Winner:** Highest bidder wins the item
- **Payment:** Winner pays the **second-highest bid**
- **Ties:** Broken randomly (coin flip); winner pays the second-highest bid amount
- **Each bidder knows ONLY their own valuation** — you do not know the human's or third bidder's valuations

**Payout per round:**
- **Winner:** Earns (their valuation − second-highest bid)
- **Losers:** Each earn $0 for that round

**Worked examples:**
1. Your valuation $7.00, you bid $7.00. Human bids $3.00, Third bidder bids $5.00. → You win (bid $7.00 is highest). Second-highest = $5.00. You earn $7.00 − $5.00 = **$2.00**.
2. Your valuation $4.00, you bid $4.00. Human bids $8.00, Third bidder bids $6.00. → Human wins. You earn **$0.00**.
3. Your valuation $8.00, you bid $8.00. Human bids $3.00, Third bidder bids $6.00. → You win. Second-highest = $6.00. You earn $8.00 − $6.00 = **$2.00**.
...
**Your payoff:** If you win, you earn your valuation minus the second-highest bid. If you lose, you earn $0.

**Key insight:** In a second-price auction, bidding your true valuation is the dominant strategy — it maximizes your expected earnings regardless of what the other bidders do. This holds whether there are 2 or 3 or more bidders.
...
- No dynamic adjustment — truthful bidding is always optimal regardless of other bidders' behavior
